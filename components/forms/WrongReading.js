    ...
    <View style={styles.container}>
      ...
      >
        ...
        <View style={styles.box}>
          <Text style={{ fontSize: 20, fontWeight: "500" }}>Wrong Reading</Text>
          <Text style={{ fontWeight: "200", marginTop: "5%" }}>
            Lodge This Complaint if current meter reading is less than reading
            mentioned on the bill.You need to mention meter reading in comments
            and submit request
          </Text>
