    ...
    <View style={styles.container}>
      ...
      >
        ...
        <View style={styles.box}>
          <Text style={{ fontSize: 20, fontWeight: "500" }}>Supply Off</Text>
          <Text style={{ fontWeight: "200", marginTop: "5%" }}>
            Register this complaint if there is no electricity in your are or if
            there is a PMT-related issue such as PMT flash or PMT fault.
          </Text>
